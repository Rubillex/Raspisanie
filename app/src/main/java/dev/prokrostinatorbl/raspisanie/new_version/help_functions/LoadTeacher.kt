...
fun LoadTeacher(context: Context, href: String, name: String, page: Int, group: String): ArrayList<TimeTableModel> {
    val result: ArrayList<TimeTableModel> = ArrayList()

    result.clear()

    Log.e("TAGS", "href: $href \n name: $name \n page: $page")

    val link_asu = "$name${getTime(page)}"
    ...
    base_elements = doc.getElementsByClass("schedule align_top").first()
